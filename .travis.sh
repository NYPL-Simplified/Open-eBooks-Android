...
org.librarysimplified.openebooks.keyAlias=nypl
org.librarysimplified.openebooks.keyPassword=${NYPL_SIGNING_KEY_PASSWORD}
org.librarysimplified.openebooks.storePassword=${NYPL_SIGNING_STORE_PASSWORD}
