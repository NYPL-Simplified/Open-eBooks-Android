...
cp -v ./simplified-app-openebooks/build/outputs/apk/debug/*.apk   "${BINARIES_DIRECTORY}"
cp -v ./simplified-app-openebooks/build/outputs/apk/release/*.apk "${BINARIES_DIRECTORY}"
